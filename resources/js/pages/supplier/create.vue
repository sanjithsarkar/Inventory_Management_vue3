<template>
    <section id="supplier-create" class="p-4">
        <div class="mb-4">
        ...
        <el-card class="box-card" shadow="hover">
            <template #header>
                <div class="text-center">
                    <h4 class="text-gray-900 m-0">Add New Supplier</h4>
                </div>
            </template>
            ...
            <el-form :model="form" label-position="top" class="max-w-3xl mx-auto">
                ...
                <div class="flex justify-center mt-6">
                    <el-button type="primary" @click="supplierInsert" :loading="loading">
                        Create Supplier
                    </el-button>
                </div>
            </el-form>
