...
const employeeUpdate = () => {
    ...
    axios.post('api/employees/' + id, formData, {
        params: form.value
    })
        .then(res => {
            if (res.data.errors) {
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="card shadow-sm my-4">
                    <div class="card-header d-flex justify-content-center">
                        <h4 class="text-gray-900">Update Employee</h4>
                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-7">
                                                <input type="file" class="m-2 py-2" id="customFile" @change="onFileSelected">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <img :src="form.image_url" v-else="" alt="no" :height="50">
                                            </div>
